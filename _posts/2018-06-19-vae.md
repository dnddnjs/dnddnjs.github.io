...
cs231n 강의 내용과 Kingma의 논문을 통해 Variational Auto-Encoder를 정리해봅니다. 다음과 같이 이 VAE 튜토리얼은 진행합니다. 
 
1. [CS231n 강의 내용](https://dnddnjs.github.io/paper/2018/06/19/vae/) 
2. [Kingma 논문 내용](https://dnddnjs.github.io/paper/2018/06/20/vae2/)
3. [VAE example 코드 리뷰](https://dnddnjs.github.io/paper/2018/06/20/vae2/)
4. VAE의 발전 형태: VQ-VAE, MusicVAE
...
<center>[그림출처:http://pyro.ai/examples/vae.html](http://pyro.ai/examples/vae.html)</center>
