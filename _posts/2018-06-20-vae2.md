...
따라서 데이터에 dependent하게 $$z$$를 sampling하기 위해 posterior $$p_{\theta}(z \vert x)$$를 정의했었는데 이 posterior는 intractable 합니다. 따라서 이 posterior를 approximate하는 새로운 posterior $$q_{\phi}(z \vert x)$$를 정의했었습니다.  
